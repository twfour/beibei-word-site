    ...
    if guide.get("pet"):
        pet_html = f"""
          <article class="intro-card pet-card">
            ...
            <div class="pet-copy"><div class="intro-label"><span>03</span> EASIER ENGLISH / 简明改写</div><h3>Read the story in easier English</h3>{intro_paragraph_html(guide['pet'], lang='en', sentences_per_paragraph=2)}<div class="pet-note">基于原文核心信息改写 · 使用 PET / CEFR B1 难度的常用词与较短句式</div></div>
          </article>"""
    introduction_html = f"""
